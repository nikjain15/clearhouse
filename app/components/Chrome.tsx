...
/**
 * Route-aware chrome. The landing ('/') is a self-contained light experience and
 * renders its own header, so it gets no chrome here. Every other page keeps the
 * dense dark instrument-panel shell.
 */
      ...
      <header className="sticky top-0 z-50 border-b border-ink-800 bg-ink-950/85 backdrop-blur">
        <div className="mx-auto flex max-w-[1400px] items-center gap-6 px-5 py-3">
          <a href="/" className="flex items-baseline gap-2.5 shrink-0">
            ...
            <span className="hidden text-[11px] text-ink-400 sm:inline">a surety bond for agentic commerce</span>
          </a>
      ...
      <footer className="mt-16 border-t border-ink-800">
        <div className="mx-auto max-w-[1400px] px-5 py-8 text-[12px] leading-relaxed text-ink-400">
          <p className="mb-3 max-w-3xl">
            <span className="text-ink-300">Honest labels.</span> The guarantee fund is simulated: the double-entry
            ledger reconciles, but no money is real. The fulfillment oracle is simulated, with real state transitions.
            Pillar 4 is 15% of the score and runs on seeded registry data. The labeled persona set validates ranking,
